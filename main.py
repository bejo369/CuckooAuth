...
#main()
#dec_num = (convertBin2Dec([1,1,1,1]))
#print (Xor_dec_with_Key(dec_num,10))
#print (convert_dec2bin(15))
#print (fit2size("1111",6))
print (xor_dec_with_Key( convertBin2Dec (left_shift("001111",4)),10))
